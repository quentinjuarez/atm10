-- startup-broadcaster.lua
--
-- Install this AS "startup.lua" on the broadcaster computer so it runs
-- automatically on every boot/reboot. It re-fetches and runs the CURRENT
-- ender-cell-broadcaster.lua straight from GitHub every time -- this
...
local URL = "https://raw.githubusercontent.com/quentinjuarez/atm10/main/scripts/ender-cell-broadcaster.lua"
