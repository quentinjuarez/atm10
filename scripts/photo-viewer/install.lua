-- install.lua (photo-viewer)
--
-- Run ONCE on the photo-viewer computer to install auto-boot:
...
local STARTUP_URL = "https://raw.githubusercontent.com/quentinjuarez/atm10/main/scripts/photo-viewer/startup.lua"
