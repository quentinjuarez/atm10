-- startup.lua (induction-broadcaster)
--
...
local URL = "https://raw.githubusercontent.com/quentinjuarez/atm10/main/scripts/powah-energy-monitor/induction-broadcaster/run.lua"
