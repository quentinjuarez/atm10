-- install.lua (induction-broadcaster)
--
-- Run ONCE on the induction-broadcaster computer to install auto-boot:
...
local STARTUP_URL = "https://raw.githubusercontent.com/quentinjuarez/atm10/main/scripts/powah-energy-monitor/induction-broadcaster/startup.lua"
