...
Two-computer system: a **broadcaster** sits on a POWAH Ender Cell and reads its energy over a modem channel, a **dashboard** listens and drives a monitor. See [`broadcaster/README.md`](./broadcaster/README.md) and [`dashboard/README.md`](./dashboard/README.md) for the decisions specific to each computer — this file only covers what's shared between them.
