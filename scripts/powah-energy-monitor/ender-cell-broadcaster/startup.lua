-- startup.lua (ender-cell-broadcaster)
--
...
local URL = "https://raw.githubusercontent.com/quentinjuarez/atm10/main/scripts/powah-energy-monitor/ender-cell-broadcaster/run.lua"
