-- install.lua (energy-detector-broadcaster)
--
-- Run ONCE on the Energy Detector broadcaster computer to install auto-boot:
...
local STARTUP_URL = "https://raw.githubusercontent.com/quentinjuarez/atm10/main/scripts/powah-energy-monitor/energy-detector-broadcaster/startup.lua"
