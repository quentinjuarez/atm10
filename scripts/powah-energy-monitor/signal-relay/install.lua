-- install.lua (signal-relay)
--
-- Run ONCE on the relay computer to install auto-boot:
...
local STARTUP_URL = "https://raw.githubusercontent.com/quentinjuarez/atm10/main/scripts/powah-energy-monitor/signal-relay/startup.lua"
