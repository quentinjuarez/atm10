-- startup.lua (induction-dashboard)
--
...
local URL = "https://raw.githubusercontent.com/quentinjuarez/atm10/main/scripts/powah-energy-monitor/induction-dashboard/run.lua"
