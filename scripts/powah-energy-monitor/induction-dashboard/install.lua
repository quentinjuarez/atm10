-- install.lua (induction-dashboard)
--
-- Run ONCE on the induction-dashboard computer to install auto-boot:
...
local STARTUP_URL = "https://raw.githubusercontent.com/quentinjuarez/atm10/main/scripts/powah-energy-monitor/induction-dashboard/startup.lua"
