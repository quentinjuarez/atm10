-- install.lua (video-player)
--
-- Run ONCE on the video-player computer to install auto-boot:
...
local STARTUP_URL = "https://raw.githubusercontent.com/quentinjuarez/atm10/main/scripts/video-player/startup.lua"
